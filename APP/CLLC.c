...
static inline void CLLC_runVotageLoop(void)
{
    ...
    {
        CLLC_gvPrim2Sec_out = DCL_runPI_C1(&CLLC_gvPrim2Sec, CLLC_vSecSensed_pu, CLLC_vSecRef_pu);
...
void CLLC_initGlobalVariables(void)
{
    ...
    CLLC_powerFlowState.CLLC_PowerFlowState_Enum = 1;

    CLLC_gvPrim2Sec_out = 0.1f;
    CLLC_PRIM_TimeShift_ticks = 0;
    CLLC_SEC_TimeShift_ticks = 0;

    CLLC_vPrimRef_pu = 0.0f;
    CLLC_vSecRef_pu = 0.1f;
